...
# Contrato/clase CosmosQueryParameter: agrupa una responsabilidad concreta sin acoplarla a ADA.
class CosmosQueryParameter:
    ...
    # Operación as_sdk_value: expone una frontera explícita y sanitizada del conector.
...
@dataclass(frozen=True, slots=True)
# Contrato/clase CosmosPatchOperation: agrupa una responsabilidad concreta sin acoplarla a ADA.
...
@dataclass(frozen=True, slots=True)
# Contrato/clase CosmosPage: agrupa una responsabilidad concreta sin acoplarla a ADA.
class CosmosPage(Generic[T]):
    ...
    @property
    # Operación item_count: expone una frontera explícita y sanitizada del conector.
...
@dataclass(frozen=True, slots=True)
# Contrato/clase CosmosContainerSpec: agrupa una responsabilidad concreta sin acoplarla a ADA.
...
# Operación normalize_patch_operations: expone una frontera explícita y sanitizada del conector.
...
# Helper interno _require_json_path: valida o adapta datos antes de tocar el SDK.

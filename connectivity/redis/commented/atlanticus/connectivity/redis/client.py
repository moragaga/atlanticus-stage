...
# El cliente no conoce prefixes ni nombres de conexión definidos por la aplicación.
class RedisClient:
    ...
    def _get_client(self) -> Any:
        ...
        if self._client is not None:
            return self._client
        sdk = self._get_sdk()
        # El esquema redis/rediss define el transporte; la autenticación se entrega aparte.
        ...
        try:
            client = sdk.Redis(
                ...
                # RESP2 mantiene un contrato pequeño y predecible para esta primera versión.
                protocol=2,
                legacy_responses=True,
                # No ocultamos reintentos de red dentro del SDK.

...
# Puerto convencional usado sólo cuando la URL no declara uno.
...
# La URL se descompone internamente; este tipo no forma parte de la API pública.
...
# La composición entrega URL, username y password como valores finales separados.
@dataclass(frozen=True, slots=True)
class RedisSettings:
    ...
    def __post_init__(self) -> None:
        # Validamos y canonizamos el endpoint sin tocar usuario ni password.
        ...
        # redis:// exige una autorización explícita para escenarios controlados como Docker local.
...
# Rechazamos credenciales, database y parámetros dentro de la URL para no mezclar responsabilidades.

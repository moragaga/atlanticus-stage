...
# Este modelo corta la dependencia con BlobProperties del SDK y deja al backend trabajar sólo con
# tipos Atlanticus estables. MappingProxyType evita que metadata cambie después de construirlo.

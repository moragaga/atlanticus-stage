...
# Las clases separan fallos locales, de transporte y de respuesta sin exponer HTTPX.
...
class HttpTimeoutError(HttpError):
    ...
    def __init__(
        ...
        *,
        ...
        # La excepción conserva solo metadatos acotados y seguros para decisiones de reintento.
...
class HttpStreamError(HttpError):
    ...
    def __init__(self, *, bytes_transferred: int) -> None:
        # El consumidor usa el conteo confirmado para descartar o gestionar el destino parcial.
        self.bytes_transferred = _require_non_negative_integer(
            bytes_transferred,
            'bytes_transferred',
        )

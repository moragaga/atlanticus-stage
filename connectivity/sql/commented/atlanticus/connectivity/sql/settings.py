...
# Son nombres aceptados del secreto heredado; no seleccionan el binario real del runtime.
...
class SqlSettings:
    ...
    def __post_init__(self) -> None:
        ...
        # Valida temprano Driver y Connection Timeout legacy sin mutar el secreto almacenado.
...
# mssql-python reserva Driver y no acepta Connection Timeout en la cadena; traducimos ambos.
...
# El timeout legacy se valida como entero no negativo antes de enviarlo a connect(timeout=...).
...
# El scanner respeta valores entre llaves para no cortar contraseñas con punto y coma.

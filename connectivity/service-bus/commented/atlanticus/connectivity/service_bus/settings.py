...
# La composición externa entrega valores finales; este módulo no conoce variables SERVICE_BUS_*.
...
# La credencial se valida sin normalizarla: no se eliminan espacios ni se reconstruye su contenido.

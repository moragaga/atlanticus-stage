...
_PRODUCTION_ROOT = _PACKAGE_ROOT / 'src/atlanticus/connectivity/service_bus'
_COMMENTED_ROOT = _PACKAGE_ROOT / 'commented/atlanticus/connectivity/service_bus'
...
def test_commented_mirror_contains_same_python_files() -> None:

# Espejo comentado del productor PI reutilizable: job.py
...
from atlanticus.data_producers.pi.errors import PiDataProducerTimeoutExhaustedError
...
class PiDataProducerJob:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.materializer, PiDataProducerMaterializer):
            raise TypeError('materializer must be a PiDataProducerMaterializer')
    ...
    def _record_timeout_skip(
        *,
        ...
        error: PiDataProducerTimeoutExhaustedError,
    ) -> None:

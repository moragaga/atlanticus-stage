# Los contratos describen únicamente datos declarativos que el catálogo puede configurar.
# StockMetricDefinition evita mezclar la definición de métricas con la mecánica de lectura o materialización.

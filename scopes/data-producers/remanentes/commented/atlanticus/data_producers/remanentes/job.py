# El job coordina los streams de forma secuencial y con fairness por último éxito.
# El cursor solo avanza después de materializar y persistir correctamente el estado del stream.

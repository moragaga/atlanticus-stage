# La materialización traduce el resultado del producer al contrato neutral de atlanticus.datasets.
# La ruta sigue siendo remanentes/<stream>/year=YYYY/month=MM/day=DD.
# El merge previo conserva snapshots de otros timestamps dentro de la misma partición diaria.

# Los modelos separan explícitamente streams de stocks y streams tabulares.
# Así no existe una combinación inválida de tipo de transformación con campos opcionales.
# La zona horaria se usa solo para interpretar la partición y timestamp del archivo fuente.

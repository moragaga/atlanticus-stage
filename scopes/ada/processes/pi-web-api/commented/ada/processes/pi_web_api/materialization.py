# Espejo pedagógico: INTERPOLATED conserva el eje de slots; RECORDED conserva el timestamp nativo truncado a segundos y merge sparse.
...
# RECORDED no se alinea a interpolation_seconds: el evento conserva su segundo UTC real.
...
# El merge físico hace ganar la fila entrante completa; aquí completamos sus nulos con la fila vigente para obtener semántica sparse.

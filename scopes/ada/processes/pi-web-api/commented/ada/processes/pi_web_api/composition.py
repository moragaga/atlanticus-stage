# Espejo pedagógico: la composición normal permanece intacta y el benchmark se bifurca solo por configuración.
# En modo stress se usa catálogo físico aislado, planner histórico, fan-out posterior a PI y cierre al confirmar el objetivo.

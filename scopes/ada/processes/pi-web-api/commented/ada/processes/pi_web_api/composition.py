# Composición productiva del process: conecta contratos explícitos sin rutas alternativas.
# El runtime sigue genérico; el planner PI decide el wake adaptativo y el recovery.

# Define los contratos internos inmutables de catálogo, planificación y resultados Blockgrade.
...
class BlockgradeSourceDefinition:
    ...
    def __post_init__(self) -> None:
        ...
        if self.load_strategy is BlockgradeLoadStrategy.FULL_SNAPSHOT and shift_id_column is not None:

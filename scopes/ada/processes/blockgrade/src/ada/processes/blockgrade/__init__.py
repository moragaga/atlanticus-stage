...
def build_catalog() -> tuple[Any, ...]:
    from ada.processes.blockgrade.catalog import build_catalog as _build_catalog

    return _build_catalog()


def build_composition(*, configuration: Any, catalog: tuple[Any, ...] | None = None) -> Any:
    from ada.processes.blockgrade.composition import build_composition as _build_composition
...
def run(
    *,
    ...
    from ada.processes.blockgrade.bootstrap import run as _run

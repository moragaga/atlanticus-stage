...
def test_project_contract_pins_productive_dependencies() -> None:
    ...
    assert 'atlanticus-job-runtime==0.7.1' in project['dependencies']
...
def test_lock_preserves_alarm_runtime_and_shared_data_baselines() -> None:
    ...
    assert versions['ada-alarms-runtime-process'] == '0.14.2'
    ...
    assert versions['atlanticus-job-runtime'] == '0.7.1'

# Expone la composición estable Core → Persistence del proceso de Alarm Runtime.
# Los detalles físicos de fencing permanecen encapsulados detrás de la raíz de composición.

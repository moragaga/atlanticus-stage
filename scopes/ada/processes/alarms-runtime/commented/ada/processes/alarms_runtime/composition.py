...
class AlarmRuntimeComposition:
    ...
    def load_group(
        ...
        *,
        ...
        # La lectura normal parte del snapshot materializado; sólo si falta se consulta el WAL para distinguir neutralidad de corrupción.
    ...
    # Este escaneo queda restringido al caso excepcional de snapshot ausente y evita inventar un baseline neutral después de actividad durable.

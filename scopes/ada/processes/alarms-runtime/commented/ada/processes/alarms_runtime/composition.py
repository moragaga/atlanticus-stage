...
# Esta composición construye la persistencia de alarmas sobre la raíz compartida resuelta por Job Runtime.
# No fija todavía scheduling ni ciclo funcional porque esos parámetros dependen del Engine y sus mediciones.

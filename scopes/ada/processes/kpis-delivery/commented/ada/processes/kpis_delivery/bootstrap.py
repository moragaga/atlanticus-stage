# El bootstrap resuelve configuración local o Key Vault y construye el proceso ejecutable sin dependencias globales.
# La ausencia o corrupción de configuración no se convierte en stores vacíos: el error se propaga.

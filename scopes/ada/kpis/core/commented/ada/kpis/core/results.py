# Modela el resultado contractual producido por el engine y la fotografía completa de un tick KPI.
# VALUE conserva valor y parsed_value; JSON conserva dict/list nativo y nunca parsed_value.

# Conserva la semántica simple del KpiSpec legacy: el spec declara y el resolver solo calcula.
# El planner podrá fusionar lecturas físicas sin cambiar los requisitos que recibe cada resolver.

# Vista restringida de dependencias para OverKpiSpec.
# El resolver derivado solo puede leer las keys declaradas en su contrato.
...
# Mapping acotado: cualquier key no declarada produce un error tipado.
...
# Validación mínima para preservar keys de dependencia estables.

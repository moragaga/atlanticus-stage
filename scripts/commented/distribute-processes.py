# El catálogo asigna números de job permanentes por responsabilidad; Delivery comienza en 41.
# La selección conserva el orden del catálogo y nunca renumera un subconjunto.
#!/usr/bin/env python3

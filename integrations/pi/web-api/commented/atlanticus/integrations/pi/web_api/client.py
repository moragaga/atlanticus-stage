# Composition root liviano: posee HttpClient y expone recursos.
# No implementa endpoints; delega cada capacidad al recurso correspondiente.
...
class PiWebApiClient:
    ...
    # El lifecycle HTTP se mantiene explícito y compartido entre los recursos.
    def open(self) -> None:

# El resultado expresa qué ocurrió; el adaptador conserva sus métricas físicas específicas.
...
class PublicationSkipReason(StrEnum):
    ...
    # En 0.1.0 no se aceptan políticas configurables ni otros motivos implícitos.
...
class DatasetPublicationResult:
    ...
    def skipped_empty(
        ...
        *,
        ...
        # No hay bytes, firma ni artefactos porque el guard debe ejecutarse antes del adaptador físico.
        return cls(
            target=target,
...
class DatasetBatchResult:
    ...
    def __post_init__(self) -> None:
        ...
        # Un target es una unidad: reportarlo dos veces escondería cuál fue su efecto real.

# Resuelve cron numérico de cinco campos sin acoplar el runtime a Azure ni a otro scheduler.
# El cron es metadata efectiva de la invocación: de él se obtienen el slot vigente y el siguiente.
# La búsqueda se hace en minutos UTC y luego se evalúa en la timezone declarada para respetar cambios horarios.

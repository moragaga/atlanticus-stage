# La definición fija límites e identidades antes de iniciar observabilidad o acceder al volumen.
...
class JobDefinition:
    ...
    def __post_init__(self) -> None:
        ...
        # None delega al runner una espera adaptativa limitada por la ventana segura total.

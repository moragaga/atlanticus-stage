...
class ObservabilityLogger:
    ...
    def exception(
        ...
        **attributes: Any,
        ...
        # La excepción se transforma por el constructor seguro; el mensaje del logger sí es texto
        # controlado por la aplicación y permanece separado del diagnóstico automático.
        return self.log(
            EventSeverity.ERROR,
            message,
            event_name=event_name,

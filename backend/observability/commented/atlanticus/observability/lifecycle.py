    ...
    with execution_scope(run_id=run_id, correlation_id=correlation_id) as context:
        ...
        with trace_span(
            ...
            try:
                ...
                # Se registra el fallo sin consumirlo: el bloque vuelve a lanzar la misma excepción.
                emit_event(
                    ObservabilityEvent(
    ...
    with iteration_scope(iteration) as context:
        ...
        with trace_span(
            ...
            try:
                ...
                # La iteración conserva el mismo contrato fail-safe que la ejecución completa.
                emit_event(
                    ObservabilityEvent(

...
class ConfigurationVariableSpec:
    ...
    def __post_init__(self) -> None:
        # Las anotaciones no impiden que un consumidor entregue tipos incorrectos en runtime.
...
class ResolvedConfiguration:
    ...
    def __post_init__(self) -> None:
        ...
        # frozen protege atributos y MappingProxyType protege el contenido de los mappings.
        ...
        # El resultado resuelto contiene únicamente nombres oficiales y textos ya normalizados.
        ...
        # ENVIRONMENT siempre forma parte del resultado y debe representar el objeto asociado.
    ...
    def __repr__(self) -> str:
        # Solo se muestran las claves disponibles, nunca sus valores.
    ...
    def to_dict(self, *, mask_sensitive: bool = True) -> dict[str, str]:
        ...
        # El valor predeterminado es seguro; revelar secretos requiere una decisión explícita.
...
# La validación distingue ausencia de contenido, pero nunca modifica espacios ni otros caracteres.
def normalize_configuration_value(
    ...
    *,
    ...
    if value is None:
        return None
    if not isinstance(value, str):
        # Cuando se conoce la variable, el diagnóstico conserva la frontera exacta que falló.
